...
export class ServicioDomicilioComponent extends BaseServiceComponent {
  ...
  protected initRoutes(): void {
    this.setBreadcrumbs([
      ...
      {
        active: false,
        name: this.translate.instant('BREADCUMTEXT.SERVICIO_DOMICILIO'),
        route: '/servicio-domicilio'
      }
    ]);
  }
}
