...
export class PodologiaGeriatricaComponent extends BaseServiceComponent {
  ...
  protected initRoutes(): void {
    this.setBreadcrumbs([
      ...
      {
        active: false,
        name: this.translate.instant('BREADCUMTEXT.PODOLOGIA_GERIATRICA'),
        route: '/podologia-geriatrica'
      }
    ]);
  }
}
