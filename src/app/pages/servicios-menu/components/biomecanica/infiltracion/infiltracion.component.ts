...
@Component({
  selector: 'app-infiltracion',
  templateUrl: './infiltracion.component.html',
  styleUrls: ['./infiltracion.component.scss']
})
export class InfiltracionComponent extends BaseServiceComponent {
  ...
  protected initRoutes(): void {
    this.setBreadcrumbs([
      ...
      {
        active: false,
        name: this.translate.instant('BREADCUMTEXT.INFILTRACIONES'),
        route: '/infiltracion'
      }
    ]);
  }
