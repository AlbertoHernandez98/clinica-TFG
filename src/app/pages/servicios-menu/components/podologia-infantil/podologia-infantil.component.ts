...
export class PodologiaInfantilComponent extends BaseServiceComponent {
  ...
  protected initRoutes(): void {
    this.setBreadcrumbs([
      ...
      {
        active: false,
        name: this.translate.instant('BREADCUMTEXT.PODOLOGIA_INFANTIL'),
        route: '/podologia-infantil'
      }
    ]);
  }
}
