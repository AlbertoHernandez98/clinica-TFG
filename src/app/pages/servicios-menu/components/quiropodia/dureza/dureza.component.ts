...
@Component({
  selector: 'app-dureza',
  templateUrl: './dureza.component.html',
  styleUrls: ['./dureza.component.scss']
})
export class DurezaComponent extends BaseServiceComponent {
  ...
  protected initRoutes(): void {
    this.setBreadcrumbs([
      ...
      {
        name: this.translate.instant('BREADCUMTEXT.DUREZA'),
        route: '/dureza',
        active: false
      }
    ]);
