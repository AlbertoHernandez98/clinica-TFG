...
@Component({
  selector: 'app-heloma',
  templateUrl: './heloma.component.html',
  styleUrls: ['./heloma.component.scss']
})
export class HelomaComponent extends BaseServiceComponent {
  ...
  protected initRoutes(): void {
    this.setBreadcrumbs([
      ...
      {
        name: this.translate.instant('BREADCUMTEXT.HELOMA'),
        route: '/heloma',
        active: false
      }
    ]);
